#pragma once
// ---------------------------------------------------------------------
// White tables (a8..h1 reading order, index 0 = a8)
// ---------------------------------------------------------------------

static const int mg_pawn_table_w[64] = {
...
static const int eg_pawn_table_w[64] = {
...
static const int mg_knight_table_w[64] = {
...
static const int eg_knight_table_w[64] = {
...
static const int mg_bishop_table_w[64] = {
...
static const int eg_bishop_table_w[64] = {
...
static const int mg_rook_table_w[64] = {
...
static const int eg_rook_table_w[64] = {
...
static const int mg_queen_table_w[64] = {
...
static const int eg_queen_table_w[64] = {
...
static const int mg_king_table_w[64] = {
...
static const int eg_king_table_w[64] = {
...
// ---------------------------------------------------------------------
// Black tables (vertical mirror of White's: rank flipped, file same)
// ---------------------------------------------------------------------

static const int mg_pawn_table_b[64] = {
    0,  0,   0,   0,   0,  0,   0,  0,  -35, -1,  -20, -23, -15, 24, 38, -22, -26, -4,  -4, -10, 3,  3,
    33, -12, -27, -2,  -5, 12,  17, 6,  10,  -25, -14, 13,  6,   21, 23, 12,  17,  -23, -6, 7,   26, 31,
    65, 56,  25,  -20, 98, 134, 61, 95, 68,  126, 34,  -11, 0,   0,  0,  0,   0,   0,   0,  0,
};

static const int eg_pawn_table_b[64] = {
    0,  0,  0,  0,  0,   0,   0,   0,   13,  8,   8,   10,  13, 0, 2,  -7, 4,  7,  -6, 1,   0,  -5,
    -1, -8, 13, 9,  -3,  -7,  -7,  -8,  3,   -1,  32,  24,  13, 5, -2, 4,  17, 17, 94, 100, 85, 67,
    56, 53, 82, 84, 178, 173, 158, 134, 147, 132, 165, 187, 0,  0, 0,  0,  0,  0,  0,  0,
};

static const int mg_knight_table_b[64] = {
    -105, -21, -58, -33, -17, -28, -19, -23, -29, -53, -12, -3,  -1,   18,  -14, -19, -23, -9,  12,  10,   19, 17,
    25,   -16, -13, 4,   16,  13,  28,  19,  21,  -8,  -9,  17,  19,   53,  37,  69,  18,  22,  -47, 60,   37, 65,
    84,   129, 73,  44,  -73, -41, 72,  36,  23,  62,  7,   -17, -167, -89, -34, -49, 61,  -97, -15, -107,
};

static const int eg_knight_table_b[64] = {
    -29, -51, -23, -15, -22, -18, -50, -64, -42, -20, -10, -5,  -2,  -20, -23, -44, -23, -3,  -1,  15,  10, -3,
    -20, -22, -18, -6,  16,  25,  16,  17,  4,   -18, -17, 3,   22,  22,  22,  11,  8,   -18, -24, -20, 10, 9,
    -1,  -9,  -19, -41, -25, -8,  -25, -2,  -9,  -25, -24, -52, -58, -38, -13, -28, -31, -27, -63, -99,
};

static const int mg_bishop_table_b[64] = {
    -33, -3, -14, -21, -13, -12, -39, -21, 4,  15, 16, 0,   7,   21, 33,  1,   0,   15,  15,  15, 14, 27,
    18,  10, -6,  13,  13,  26,  34,  12,  10, 4,  -4, 5,   19,  50, 37,  37,  7,   -2,  -16, 37, 43, 40,
    35,  50, 37,  -2,  -26, 16,  -18, -13, 30, 59, 18, -47, -29, 4,  -82, -37, -25, -42, 7,   -8,
};

static const int eg_bishop_table_b[64] = {
...
static const int mg_rook_table_b[64] = {
...
static const int eg_rook_table_b[64] = {
    -9, 2,   3,  -1, -5, -13, 4,  -20, -6, -6,  0, 2, -9, -9, -11, -3, -4, 0,  -5, -1, -7, -12,
    -8, -16, 3,  5,  8,  4,   -5, -6,  -8, -11, 4, 3, 13, 1,  2,   1,  -1, 2,  7,  7,  7,  5,
    4,  -3,  -5, -3, 11, 13,  13, 11,  -3, 3,   8, 3, 13, 10, 18,  15, 12, 12, 8,  5,
};

static const int mg_queen_table_b[64] = {
...
static const int eg_queen_table_b[64] = {
    -33, -28, -22, -43, -5,  -32, -20, -41, -22, -23, -30, -16, -16, -23, -36, -32, -16, -27, 15,  6,  9, 17,
    10,  5,   -18, 28,  19,  47,  31,  34,  39,  23,  3,   22,  24,  45,  57,  40,  57,  36,  -20, 6,  9, 49,
    47,  35,  19,  9,   -17, 20,  32,  41,  58,  25,  30,  0,   -9,  22,  22,  27,  27,  19,  10,  20,
};

static const int mg_king_table_b[64] = {
...
static const int eg_king_table_b[64] = {
...
// ---------------------------------------------------------------------
// [color][piece][square] lookup tables
// color: 0 = White, 1 = Black   (match this to your Color enum order!)
// piece: 0=pawn 1=knight 2=bishop 3=rook 4=queen 5=king
// ---------------------------------------------------------------------

static const int *mg_pesto_table[2][6] = {
    {mg_pawn_table_w, mg_knight_table_w, mg_bishop_table_w, mg_rook_table_w, mg_queen_table_w, mg_king_table_w},
    {mg_pawn_table_b, mg_knight_table_b, mg_bishop_table_b, mg_rook_table_b, mg_queen_table_b, mg_king_table_b},
};

static const int *eg_pesto_table[2][6] = {
